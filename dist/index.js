...
app.post('/auth/login', async (c) => {
    ...
    const entitlement = quota_1.QuotaManager.calculate(balance, price, lastTransfer);
    ...
    const token = await (0, jwt_1.sign)({ sub: wallet, exp: Math.floor(Date.now() / 1000) + 86400 }, JWT_SECRET);
    return c.json({
        token,
        wallet,
        quota: entitlement,
